...
type
  TProductForm = class(TForm)
    ...
    procedure ProdSupBeforeOpen(DataSet: TDataset);
...
procedure TProductForm.ProdSupBeforeOpen(DataSet: TDataset);
begin
{  ProdSup.Open;}
end;
...
procedure TProductForm.PrintSpdBtnClick(Sender: TObject);
begin
  Print;
end;

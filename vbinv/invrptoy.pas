...
type
  TfrmInvoiceOY = class(TForm)
    qrpInvoiceY: TQuickRep;
...
procedure TfrmInvoiceOY.qrgTariffDescrBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
...
procedure TfrmInvoiceOY.qrbGroupFooterBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TfrmInvoiceOY.qrpInvoiceYBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlTariffDescr.Caption:='Tariff Descr not set';
end;
